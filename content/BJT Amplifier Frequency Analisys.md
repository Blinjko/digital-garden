When making a [[Bipolar Junction Transistors (BJT)|BJT]] amplifier one of the things we design for is a particular [[Bode Plots|frequency response]]. So then, using the [[Bipolar Junction Transistors (BJT)|Small Signal Model]] how can we account for frequency?
...
We see that all we really add is a capacitor between the base and emitter, and another capacitor between the base and collector. There also seems to be a resistance included at the beginning.

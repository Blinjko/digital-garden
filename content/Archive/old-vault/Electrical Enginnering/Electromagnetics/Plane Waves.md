...
### Thickness Needed for no Reflection (Anti Reflective coating)

To compute the thickness $L$ for this intermediate layer such that there is no reflection for an anti reflective coating, we can use the transmission line analogy and our techniques from there to derive
$$
